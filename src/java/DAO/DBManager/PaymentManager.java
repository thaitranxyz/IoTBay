...
public class PaymentManager {
	...
	public void addPaymentDetails(String creditCardNumber, String creditCardExpiry, String creditCardCVC, int isDefaultValue, int customerId) throws SQLException {
        ...
        public ArrayList<Payment> getPaymentList(int userId) throws SQLException {
            try {
                ResultSet results = st.executeQuery("SELECT * FROM IOTBAY.PAYMENT WHERE CUSTOMERID=" + userId);
    ...
    public void UpsertCustomer(User user) throws SQLException {        
